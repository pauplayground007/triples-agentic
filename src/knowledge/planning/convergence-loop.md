...
4. **Human review** — when gaps need product, design, technical, or release judgment, ask specific questions.
5. **Revise** — incorporate decisions, preserve approved sections, and record meaningful changes.
6. **Repeat** — continue Review → Evaluate until `READY` or escalation threshold is reached.
